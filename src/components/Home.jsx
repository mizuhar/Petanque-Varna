...
useEffect(() => {
    ...
    return(
        ...
        <br />
        <p></p>
        <h1 style={{color:'wheat',fontSize:'51px',marginTop:'1em',marginBottom:"1.5em",width:"200%"}}>{username ? `${username}, welcome to petanque Varna!`:'Welcome to petanque Varna!'} </h1>
        <br />
        ...
        <div className={styles.player}>
                ...
                {players.map((player) => (
                    ...
                    <div className="image-wrap">
                        <img style={{width:"200px",height:"300px",borderRadius:"10px",marginLeft:"2em",clipPath:'circle(50%)'}} src={player.img} />
                    </div>
